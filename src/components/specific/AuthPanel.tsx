...
// src/components/specific/AuthPanel.tsx
import React, { useState } from "react";
import LoginPanel from "./LoginPanel";
import SignupPanel from "./SignupPanel";
...
const AuthPanel: React.FC = () => {
  ...
  return (
    <div className="relative z-[99999] pointer-events-auto w-full max-w-sm bg-white rounded-lg shadow-xl overflow-hidden h-[650px]">
      {/* 탭 헤더 */}
      <div className="flex border-b border-gray-200">
        <button
          className={`flex-1 py-3 text-center text-lg font-semibold transition duration-150 ${
